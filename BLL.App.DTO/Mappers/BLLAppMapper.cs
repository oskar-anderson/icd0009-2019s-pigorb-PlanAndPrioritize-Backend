...
namespace BLL.App.DTO.Mappers
{
        ...
        where TRight : class, new()
    {
        public BLLAppMapper()
        {
            ...
            MapperConfigurationExpression.CreateMap<FeatureStatusDalDto, FeatureStatusBllDto>();
            MapperConfigurationExpression.CreateMap<PriorityStatusDalDto, PriorityStatusBllDto>();
            ...
            MapperConfigurationExpression.CreateMap<VotingStatusDalDto, VotingStatusBllDto>();
            ...
            MapperConfigurationExpression.CreateMap<FeatureStatusBllDto, FeatureStatusDalDto>();
            MapperConfigurationExpression.CreateMap<PriorityStatusBllDto, PriorityStatusDalDto>();
            ...
            MapperConfigurationExpression.CreateMap<VotingStatusBllDto, VotingStatusDalDto>();
